...
//        properties.setProperty("auto.offset.reset", "latest");
        ...
        DataStreamSource<String> kafka_source = env.fromSource(kafkaSource, WatermarkStrategy.noWatermarks(), "Kafka_source");
